...
\033[1;91m<═══\033[1;41m\033[1;97m Created by ELHAKEM \033[;0m\033[1;91m═══>\033[1;92m""")
...
\033[1;97m➤ \033[1;92mTool BruteX is created by ELHAKEM
\033[1;92m""")
...
# main script start
os.system("xdg-open https://youtube.com/@elhakemyt9003")
time.sleep(5)
	...
	if menu == '01' or menu == '1':
		...
		while True:
			...
			if fol == '1' or fol == '01':
				...
				time.sleep(1)
				os.system("xdg-open https://t.me/mosLord777")
